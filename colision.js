...
class Circle { 
    ...
    checkCollision(otherCircle) {
        // Calcular distancia entre centros usando fórmula de distancia
...
function checkAllCollisions() {
    // Primero resetear todos los estados de colisión
    circles.forEach(circle => {
        circle.isColliding = false;
    });
    
    // Verificar colisiones entre todos los pares de círculos
    ...
    // Actualizar colores basado en el estado de colisión
    circles.forEach(circle => {
...
function animate() { 
    ...
    // Verificar colisiones después de actualizar posiciones
    checkAllCollisions();
